...
void WorldSession::loadHandlers()
{
    ...
    // WorldPacketHandlers[CMSG_DELETEEQUIPMENT_SET].handler = &WorldSession::HandleSetTargetOpcode;
    ...
    //WorldPacketHandlers[CMSG_LEARN_TALENT_GROUP].handler = &WorldSession::handleLearnMultipleTalentsOpcode;
    ...
    //WorldPacketHandlers[CMSG_ON_MISSILE_TRAJECTORY_COLLISION].handler = &WorldSession::handleUpdateProjectilePosition;
    ...
    //WorldPacketHandlers[CMSG_RIDE_VEHICLE_INTERACT].handler = &WorldSession::HandleEnterVehicle;
    //WorldPacketHandlers[CMSG_CONTROLLER_EJECT_PASSENGER].handler = &WorldSession::HandleRemoveVehiclePassenger;

...
void Spell::SpellEffectSchoolDMG(uint8_t effectIndex) // dmg school
{
    ...
    else
    {
        ...
        switch (GetSpellInfo()->getId())
        {
            ...
            case 17962:
                unitTarget->removeAuraState(AURASTATE_FLAG_CONFLAGRATE);
                break;
            ...
            case 34428:
            {
                if (p_caster != nullptr)
                {
                    p_caster->removeAuraState(AURASTATE_FLAG_SWIFTMEND);
            ...
            case 18562: //druid - swiftmend
            {
                if (unitTarget)
                {
                    ...
                    if (taura && taura->GetSpellInfo())
                    {
                        ...
                        {
                            unitTarget->removeAuraState(AURASTATE_FLAG_SWIFTMEND);
